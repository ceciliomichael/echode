import { Settings, FileText, Wrench, ChevronDown, Zap, Brain, GitCommit, Network, Settings2, ScrollText } from 'lucide-react';
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold">
            {activeTab === 'api' ? 'API Configuration' : activeTab === 'system' ? 'System Prompt' : activeTab === 'tools' ? 'Tools' : activeTab === 'autocomplete' ? 'Autocomplete' : activeTab === 'context' ? 'Context' : activeTab === 'mcp' ? 'MCP Servers' : activeTab === 'miscellaneous' ? 'Miscellaneous' : activeTab === 'workflows' ? 'Workflows' : 'Commit Message'}
          </span>
        </div>
        <ChevronDown
          size={16}
