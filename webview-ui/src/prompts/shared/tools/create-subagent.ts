...
- allowedTools: (REQUIRED) Array of tool names the sub-agent can use (e.g., ["read_file", "grep_search", "report_back"])
...
- Always include "report_back" in allowedTools so the sub-agent can return results
